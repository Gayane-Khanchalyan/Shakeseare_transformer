...
txt = '''       <font style=”line-height: 200%” face = "Times" size = "12"> The aim of the task was to create a transformer language model which will generate a text with Shakespeare style. \
...
higher probability that the next token is EOS (end of the sentence) than any other word. \
...
and transformer training with more epoches can raise the performance of the model.</font>
'''
...
txt = '''    As the aim of the project is to generate new words, we have used only the 'PlayerLine' column from the Shakeseare dataset, \
...
similar to normal texts. Figure 1 below shows the word cloud of the Shakesearian vocabulary. 
'''
...
pdf.image(name='../output/images/model_structure.png',w=130, h=80)
